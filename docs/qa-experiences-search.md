...
## QA Tickets (DARE)
1) **[Search] Thiếu Example Links/CTA như các list experiences**
...
2) **[Search] Không phản ánh trạng thái module trong toggle (chưa disable)**
...
3) **[Search] Không có liên kết “Module & liên kết”/status chi tiết**
...
4) **[Search] Không có cấu hình pagination hoặc “postsPerPage” như list**
...
5) **[Search] Preview không dùng brandColor từ setting**
...
6) **[Search] Không có liên kết/khai báo liên quan trang chủ**
...
7) **[Search] Không có đồng bộ với site route search**
...
8) **[Search] Thiếu mô tả về module phụ thuộc trong UI**
...
9) **[Search] Không có trạng thái loading module**
   - **D**: isLoading chỉ dựa vào experienceSetting, không chờ module query.
   - **A**: list pages chờ module queries.
   - **R**: QA: render module link có thể undefined trong loading.
   - **E**: Cân nhắc chờ posts/products/services module.

10) **[Search] Không có layout option sync với legacy keys**
